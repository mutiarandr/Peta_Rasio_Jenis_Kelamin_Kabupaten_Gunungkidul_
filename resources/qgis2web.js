...
map.getView().fit([12280280.986038, -915862.725800, 12350928.586148, -865833.475844], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Rasio Jenis Kelamin Kabupaten Gunungkidul </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (238 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini merupakan peta yang menunjukkan Rasio Jenis Kelamin di Kabupaten Gunungkidul berdasarkan Kecamatan di Kabupaten Gunungkidul. <br />Dibuat Oleh	<br />Nama	: Mutiara Ayu Andriani<br />NIT	: 2502010131<br />No Presensi	: 27<br />Kelas	: SPIP D<br />Kode Soal	: D';
            }
